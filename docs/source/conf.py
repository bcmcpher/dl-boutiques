# -*- coding: utf-8 -*-
#
# datalad_boutiques documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_boutiques:command_suite',
                     '--manpath', abspath(opj(
...
project = u'Datalad Boutiques Extension'
...
# built documents.
version = datalad_boutiques.__version__
release = version
